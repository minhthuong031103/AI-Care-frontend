export const surpriseMePrompts = [
  ...
  'A mythical creatures roaming a bustling cityscape.',
  'A life-sized installation: a giant origami swan floating gracefully in a pool of shimmering water.',
  'A graffiti mural: talking trees sharing secrets and stories in a vibrant urban neighborhood.',
  'A kinetic sculpture: colorful balloons dancing and twirling in response to the wind.',
  'A stained glass window: a flock of flamingos soaring across a sunset sky.',
  'A series of ceramic teapots: enchanted forest animals with unique personalities.',
  'A photo-realistic oil painting: a steampunk-inspired underwater city with mermaids and mechanical fish.',
  'A digital art installation: abstract patterns and colors transforming the space into a dynamic kaleidoscope.',
  'A collection of intricately carved wooden masks: mythical creatures from different cultures in a multicultural exhibition.',
  'A performance art piece: dancers moving gracefully with giant, glowing fabric wings.',
  'A digital sculpture: a holographic representation of a mythical creature.',
  'A textile artwork: an intricate tapestry woven with threads of gold and silver.',
  'A minimalist installation: a single beam of light cutting through a darkened room.',
  'A ceramic sculpture: a series of human-sized teardrops stacked on top of each other.',
  'An interactive art installation: a giant puzzle that visitors can physically assemble.',
  'A kinetic art piece: a collection of metal spheres rolling and colliding in an elaborate contraption.',
];
